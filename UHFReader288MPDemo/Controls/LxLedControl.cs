...
namespace UHFReader288MPDemo
{
    public class LxLedControl : Control, ISupportInitialize
    {
        ...
        private void DrawBackground(Graphics g)
        {
            ...
            else
            {
                if (m_colCustomBk1 == Color.Transparent)
                    return;
                DrawNormalRect(g, clientRectangle, m_colCustomBk1, m_colCustomBk2, colBorder, m_bGradientBackground, m_nBorderWidth != 0);
            }
        }
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            CalculateDrawingParams(out float segmentWidth, out float segmentInterval);
